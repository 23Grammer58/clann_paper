...
\end{equation}
Здесь $S_{11}$, $S_{22}$ и $S_{12}$ — компоненты в материальном базисе $\vect{G}^{\alpha}\otimes\vect{G}^{\beta}$, согласованные с представлением $\tilde{\mathbb{F}}$ в уравнении \eqref{eq:laplace_coords}.
...
\textbf{Гиперупругие ограничения}
