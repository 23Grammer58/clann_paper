...
Let \(\vect{X}\) and \(\vect{x}\) denote point positions in the corresponding bases \(\vect{E}_{\alpha}\) and \(\vect{e}_{\alpha}\) in the reference (undeformed) \(\Omega_0 \subset \mathbb{R}^2\) and current (deformed) \(\Omega_t \subset \mathbb{R}^2\) configurations of the membrane midsurface, respectively.
